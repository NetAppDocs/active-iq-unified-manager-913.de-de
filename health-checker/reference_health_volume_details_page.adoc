...
Weitere Informationen finden Sie unter link:../data-protection/task_restore_data_use_health_volume_details_page.html["Wiederherstellen von Daten mithilfe der Seite Volume / Health Details"].
...
*** Snapshot-Kopien ohne Aufbewahrungseinstellungen
In einer kaskadierenden SnapVault Beziehung, bei der die Quelle ein Datensicherungs-Volume ist, gilt nur die Regel „`sm_created`“.
