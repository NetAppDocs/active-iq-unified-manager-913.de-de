...
** San
+
Zeigt die Anzahl der SAN-Schnittstellen an, die der Speicher-VM zugeordnet sind. Außerdem gibt an, ob die Schnittstellen aktiv sind (image:../media/availability_up_um60.gif["Symbol für die LIF-Verfügbarkeit – up"]Oder runter (image:../media/availability_down_um60.gif["Symbol für LIF-Verfügbarkeit – Inaktiv"]).
